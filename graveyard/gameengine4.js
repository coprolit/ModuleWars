...
var playerAvatar;
var animationObjects = {}; // connected clients
...
function initSocket(){
    ...
    socket.on('ship launched', function(data){
        ...
        if(data.username === username){
            ...
            animationObjects[data.username] = {}; // store reference to new player
            animationObjects[data.username].avatar = createShip(data.ship, 50, data.username);
        }
    });
